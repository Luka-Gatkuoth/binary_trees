# This is the C - Binary trees

In this project i have learnt about the details, advantages,
and disadvantages of using trees as data structures. i have learned about how to qualify trees and how to traverse them as well. Throughout the project, i have
implemented binary, binary search, AVL, and Max Binary Heap trees.

## Tests :heavy_check_mark:

* [tests](./tests): Folder of test files for all the tasks. Provided by ALX.

## Helper File :raised_hands:

* [binary_tree_print.c](./binary_tree_print.c): C function that prints binary
trees in the pretty way.

## Header File :file_folder:

* [binary_trees.h](./binary_trees.h): Header file containing definitions and
prototypes for all types and functions written for project.
...
## Author
<details>
    <summary>Luka Gatkuoth Nyuot</summary>
    <ul>
    <li><a href="https://github.com/Luka-Gatkuoth">Github</a></li>
    <li><a href="https://twitter.com/Lukagatkuoth">Twitter</a></li>
    <li><a href="mailto:lukagatkuoth4@gmail.com">e-mail</a></li>
    </ul>